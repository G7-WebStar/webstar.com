<?php
$activePage = 'test-info';

include('../shared/assets/database/connect.php');
include("../shared/assets/processes/prof-session-process.php");

if (!isset($_GET['testID'])) {
    echo "Test ID is missing in the URL.";
    exit;
}
                        ...
                        <div class="col-12 cardHeader p-3 mb-4">
                            ...
                            <div class="row desktop-header d-none d-sm-flex">
                                ...
                                <div class="col-auto d-flex align-items-center">
                                    <a href="assess-exam-details.php?assessmentID=<?php echo $assessmentID; ?>" style="text-decoration: none;">
