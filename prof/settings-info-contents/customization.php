<?php
// Get all available items for professors
$myEmblems = [];
$myCovers = [];
$myThemes = [];

// Emblems
$emblemsQuery = "SELECT emblemID, emblemName AS emblemTitle, emblemPath AS emblemImg FROM emblem ORDER BY emblemName ASC";
$emblemsResult = $conn->query($emblemsQuery);
if ($emblemsResult && $emblemsResult->num_rows > 0) {
    while ($row = $emblemsResult->fetch_assoc()) {
        $myEmblems[] = $row;
    }
}
...
// Get current profile selection (for highlighting selected items)
...
<div class="container" style="overflow-x: hidden;">
    ...
    <form method="POST" id="bioForm">
        <input type="hidden" name="activeTab" value="customization">
        <div class="row mt-3 pt-1  mb-3">
            ...
            <div class="col-12 text-reg text-14 mb-2" style="text-align: justify;">
                Write a short description about yourself! Your bio appears on your profile page and helps your students get to
                know you better.
            </div>
        </div>
    ...
    <form method="POST">
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 text-reg text-14 mb-3" style="text-align: justify;">
                Choose an emblem to display on your profile!
            </div>
        </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="d-none d-md-flex align-items-center w-100">
                ...
                <div class="col position-relative w-100 overflow-hidden" style="height: 200px;">
                    <div id="carouselWrapperEmblem"
                        style="overflow-x: auto; overflow-y: hidden; width: 100%; scroll-behavior: smooth;scrollbar-width:none; -ms-overflow-style:none;">
    ...
    <form method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-12 text-reg text-14 mb-3"
                ...
                Choose a cover photo that reflects your style. 
            </div>
        </div>
    ...
    <form method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-12 text-reg text-14 mb-3"
                style="white-space: normal; word-wrap: break-word; text-align: justify;">
                Select a color theme to give your profile page a vibrant and personalized look.
            </div>
        </div>
