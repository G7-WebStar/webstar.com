                ...
                <div class="card border-0 px-3 pt-3 m-0 h-100 w-100 rounded-0 shadow-none"
                    ...
                    <div class="container-fluid overflow-y-auto py-3 px-4 px-md-5 row-padding-top">
                        <div class="row mt-3">
                                ...
                                <div class="col-12 card p-2 d-flex flex-column flex-sm-row align-items-center justify-content-between"
                                    ...
                                    <div
                                        ...
                                        <div class="card d-flex justify-content-center align-items-center"
                                            ...
                                            ?>" alt="Profile"
                                                style="object-fit:cover; border-radius:15px; width:100%; height:100%;">
                                        </div>
                                            ...
                                            <table class="table mb-0" style="width: 618px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($totalRows > 0):
                                                        ...
                                                        foreach ($allRecords as $index => $row):
                                                            ...
                                                            <tr class="text-med text-12">
                                                                ...
                                                                <td
                                                                    style="<?php echo $isLast ? '' : 'border-bottom:1px solid var(--black);'; ?>">
                                                    ...
                                                    if (!$hasRecords):
                                                        ?>
                                                        <tr>
                                                            <td colspan="4" class="text-center text-reg text-12">No records
                                                                found.</td>
                                                        </tr>
                                                    <?php endif; ?>
                                                </tbody>
                                ...
                                <div class="col d-block d-md-none">
                                    ...
                                    if (!empty($allRecords)):
                                        ...
                                        foreach ($allRecords as $record):
                                            ?>
                                            <div class="card p-3 ms-2 mb-2"
                                                style="width: 100%; max-width: 290px; border: 1px solid var(--black); border-radius: 15px;">
                            ...
                            <div class="row mx-1">
                                <?php if (!empty($studentBadges)): ?>
                                    <?php foreach ($studentBadges as $b): ?>
                                        <div class="col-12 mb-2">
                                            <div class="card py-2 py-sm-0"
                                                style="border: 1px solid var(--black); border-radius: 15px; width: 100%;">
                                                <div
