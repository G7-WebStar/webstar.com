                                        ...
                                        <div class="p-0 px-lg-5">
                                                    ...
                                                    <ul class="nav nav-tabs custom-nav-tabs mb-3 flex-nowrap" id="myTab"
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" id="announcements-tab"
                                                                ...
                                                                role="tab">Exam Details</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="assess-exam-submissions.php">Submissions</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="assess-exam-analytics.php">Analytics</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="announcements"
                                                    ...
                                                    <p class="mb-5 mt-2 text-med text-14">Attached is a Google Doc that
                                                        you can
                                                        edit.
                                                    </p>
                                                    <p class="mb-5 mt-2 text-med text-14">In Figma, design a "404 Not
                                                        Found"
                                                        page.</p>
                                                    <p class="mb-1 mt-2 text-med text-14">Create two versions, one for
                                                        the
                                                        mobile and
                                                ...
                                                <div class="row align-items-center justify-content-center mt-5 mb-3">
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="submission-stats">
                                                            ...
                                                            <div class="text-reg text-14"><span
                                                                    class="stat-value">11</span> pending submission</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
