...
if (!$username && isset($_SESSION['userID'])) {
    ...
    ";
    $badgeQuery = "
        SELECT b.badgeName, b.badgeIcon, b.badgeDescription, COUNT(sb.badgeID) AS timesEarned
        FROM studentbadges AS sb
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="flex-fill text-center mx-1">
                                                                            <span class="text-16 text-bold">
                                                                                <?= !empty($user['totalBadges']) ? htmlspecialchars($user['totalBadges']) : '-' ?>
                                                                            </span>
                                                                            <small
                                                                        ...
                                                                        <div class="flex-fill text-center mx-1">
                                                                            <span class="text-bold">
                                                                                <?= !empty($user['totalEnrollments']) ? htmlspecialchars($user['totalEnrollments']) : '-' ?>
                                                                            </span>
                                                                        ...
                                                                        <div class="flex-fill text-center mx-1">
                                                                            <span class="text-bold">
                                                                                <?= !empty($user['webstars']) ? htmlspecialchars($user['webstars']) : '-' ?>
                                                                            </span>
                                                                            <small
