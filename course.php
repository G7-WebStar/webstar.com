                        ...
                        <div class="row m-4 justify-content-center">
                            ...
                            <div class="row header-section align-items-center justify-content-center">
                                ...
                                <div class="col-12 col-xl-8 mb-3 mb-xl-0">
                                    <div class="row g-3">
                                        <div class="col-12 col-lg-3 px-0">
                                            <p class="text-sbold mb-0 lh-md dynamic-text text-start text-sm-center text-md-start">My Courses</p>
                                        </div>
                                ...
                                <div class="col-12 col-xl-4">
                                    <div class="row g-3">
                                        <div class="col-12 d-flex justsify-content-end align-items-center px-0 px-xl-auto">
                                            <div class="col-6 d-none d-sm-flex d-lg-none justify-content-center justify-content-md-start align-items-center flex-nowrap">
                                                <span class="dropdown-label me-2 text-reg">Status:</span>
                                                <button class="btn dropdown-toggle dropdown-custom" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                    <span class="text-reg text-14">Active</span>
