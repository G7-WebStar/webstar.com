...
include("shared/assets/backend/loginbe.php");
?>
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-4 p-3 rounded-4 login-container border-blue mx-auto">
                ...
                <form method="POST" action="">
                    ...
                    <?php if ($login_error): ?>
                        <!-- Error Alert -->
                        <div id="errorModal" class="custom-alert">
                            <div class="alert-icon">
                                <img src="shared/assets/img/warning.png" alt="Warning" style="width: 15px; height: 15px;">
                            </div>

                            <div class="alert-message">Oops! Email or password incorrect.</div>
                        </div>
                    <?php endif; ?>
