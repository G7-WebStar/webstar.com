...
<nav class="navbar fixed-bottom border-top d-block d-md-none" style="background-color:white; height: 80px;">
  <div class="container d-flex justify-content-around pb-1">
    ...
    <!-- Inbox -->
    <a href="inbox.php"
      class="btn d-flex nav-btn-navbar flex-column align-items-center <?php echo ($activePage == 'inbox') ? 'selected-nav-item' : ''; ?>"
      style="border-color:transparent; text-decoration:none;">
    ...
    <!-- More -->
    <div class="dropup">
  <button class="btn nav-btn-navbar d-flex flex-column align-items-center" 
  ...
  <ul class="dropdown-menu dropdown-menu-end text-small shadow"
    ...
    <!-- Search -->
    <li style="margin-bottom:6px;">
      <a class="dropdown-item d-flex align-items-center text-med text-14" href="search.php" data-bs-toggle="modal" data-bs-target="#searchModalMobile">
    ...
    <!-- Sign Out -->
    <li>
      <a class="dropdown-item d-flex align-items-center text-med text-14" href="login.php" style="color:var(--highlight);">
