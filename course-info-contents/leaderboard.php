...
<div class="customCard text-sbold p-3">
    <div class="row">
        <div
            class="col-12 col-xl-4 mt-3 px-0 mx-auto mx-md-0 d-flex d-md-block justify-content-center justify-content-md-auto px-1">
            <div class="card rounded-4 col-6 col-md-12">
                <div class="card-body border border-black rounded-4">
                    <div class="row">
                        <div class="col-6 d-flex align-items-center">
                            <img src="https://avatars.githubusercontent.com/u/181800261?s=96&amp;v=4" alt="" width="90"
                    ...
                    <div class="row">
                        ...
                        <div class="col-9 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-3">
                                <img src="https://avatars.githubusercontent.com/u/181800261?s=96&v=4" alt="" width="40"
